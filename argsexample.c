...
int main(int argc, char *argv[]) { // Example code
    ...
    // Uncomment these to see how the argument printing functions work. They are disabled by default due to the dense output.
    // printOutNonStringArgument(&multiIntArg, int);
